...
document.querySelector('.calc').addEventListener('click', event => { /*Поведение кнопок*/
   ...
   if (action.includes(key)){
       ...
       if (sign) {
           //calc, переместить сюда калькуляцию
           //получить обновленный первый операнд

       }

       //переприсвоить sign на новое действие после калькуляции (либо если ее не было)
       //протестировать этот блок условий
       if (!'=') {
           sign = key;
   ...
   //весь блок калькуляции уезжает выше
